...
pub fn builtin_providers() -> Vec<ProviderConfig> {
    vec![
        ProviderConfig {
            ...
            base_url: "http://localhost:3000/api/talkcody/v1".to_string(),
        ...
        ProviderConfig {
            ...
            supports_coding_plan: true,
            supports_international: true,
            coding_plan_base_url: Some("https://api.kimi.com/coding/v1".to_string()),
        ...
        ProviderConfig {
            ...
            api_key_name: "QWEN_API_KEY".to_string(),
            supports_oauth: true,
            supports_coding_plan: false,
            supports_international: false,
            coding_plan_base_url: None,
